...
# 2. Run:   docker run -p 5000:5001 --env-file .env {{PROJECT_NAME}}
# 3. Test:  npx @mcp/inspector (Transport: HTTP, URL: http://localhost:5001/mcp)
#
# =============================================================================
...
# 4. Start MCP server on MCP_PORT (5001)
CMD ["mcp.yaml"]
