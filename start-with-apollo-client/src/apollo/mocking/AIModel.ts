...
- https://picsum.photos/[width]/[height]?random=[unique_number] (e.g., https://picsum.photos/400/300?random=1, ?random=2, etc.)
- https://via.placeholder.com/[width]x[height]/[color]/[text_color]?text=[context] (e.g., ?text=Product+1)
